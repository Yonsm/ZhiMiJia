...
# class Washer_Device_Fault(IntEnum):
#     _0 = 0
#     _1 = 1
#     _2 = 2
#     _3 = 3
...
# class Washer_Left_Time(IntEnum):
#     MIN = 0
#     MAX = 1440


# class Washer_Target_Temperature(IntEnum):
#     _0 = 0
#     _30 = 30
#     _40 = 40
#     _60 = 60
...
# class Washer_Spin_Speed(IntEnum):
#     _0 = 0
#     _400 = 400
#     _600 = 600
#     _800 = 800
...
class Washer_Drying_Time(IntEnum):
    不烘干 = 0
    智能烘干 = 1
    三十分钟 = 30
    一小时烘干 = 60
...
# class Washer_Rinsh_Times(IntEnum):
#     _0 = 0
#     _1 = 1
#     _2 = 2
#     _3 = 3
...
# class Washer_Speed_Level(IntEnum):
#     Level1 = 1
#     Level2 = 2
#     Level3 = 3
#     Level4 = 4
...
# class Washer_Door_State(IntEnum):
#     Open = 1
#     Closed = 2


# class Washer_Power_Consumption(IntEnum):
#     MIN = 0
#     MAX = 20000


# class Washer_Water_Consumption(IntEnum):
#     MIN = 0
#     MAX = 1000


# class Washer_Working_Time(IntEnum):
#     MIN = 0
#     MAX = 1440


# class 自定义属性_洗涤剂投放量(IntEnum):
#     _0 = 0
#     _1 = 1
#     _2 = 2


# class 自定义属性_洗涤剂消耗量(IntEnum):
#     MIN = 0
#     MAX = 200


# class 自定义属性_柔顺剂投放量(IntEnum):
#     少量 = 0
#     标准 = 1
#     多量 = 2


# class 自定义属性_柔顺剂消耗量(IntEnum):
#     MIN = 0
#     MAX = 200


# class 自定义属性_消毒剂投放量(IntEnum):
#     少量 = 0
#     标准 = 1
#     多量 = 2


# class 自定义属性_消毒剂消耗量(IntEnum):
#     MIN = 0
#     MAX = 200


# class 自定义属性_预约完成时间戳(IntEnum):
#     MIN = 0
#     MAX = 4294836225


# class 自定义属性_模式(IntEnum):
#     MIN = 0
#     MAX = 100


# class 自定义属性_耗电量(IntEnum):
#     MIN = 0
#     MAX = 65535


# class 自定义属性_耗水量(IntEnum):
#     MIN = 0
#     MAX = 255


# class 自定义属性_工作时长(IntEnum):
#     MIN = 0
#     MAX = 65535


# class 用户按键上报_按键值(IntEnum):
#     MIN = 0
#     MAX = 255


# class 用户按键上报_按键时长(IntEnum):
#     MIN = 0
#     MAX = 65535
